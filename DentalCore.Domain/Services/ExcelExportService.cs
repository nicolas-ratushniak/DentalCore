...
public class ExcelExportService : IExportService
{
    ...
    public async Task ExportVisitsAsync(DateOnly from, DateOnly to, string dirPath)
    {
        ...
        var visits = await GetVisitsForExportAsync(fromDateTime, toDateTime);
    ...
    private async Task<List<VisitExportDto>> GetVisitsForExportAsync(DateTime from, DateTime to)
    {
        var visits = await _visitService.GetAllRichAsync(from, to);
